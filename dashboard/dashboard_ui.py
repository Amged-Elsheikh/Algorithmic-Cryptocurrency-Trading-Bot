...
def footer():
    ...
    container = html.Div(
        [
            ...
            html.Section(
                [facebook, twitter, google, instagram, linkedin, github],
...
def _technicl_modal_component(title: str, indicators: Dict[str, int]):
    ...
    for indicator, value in indicators.items():
        ...
        indicator_entry.append(
            dbc.InputGroup([text, input_],
                           className='mb-3'))
